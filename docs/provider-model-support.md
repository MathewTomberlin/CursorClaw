...
- **Model config (required/optional fields per provider):** [Configuration Reference §4.15](./configuration-reference.md#415-models-and-defaultmodel) — table and examples for all four providers.
...
New providers (e.g. LM Studio) are out of scope for the current matrix; see [PMR §8](PMR-provider-model-resilience.md#8-local-and-optional-providers-ollama) for the “optional local provider” pattern and implementation-guide-first approach.
