...
| **openai-compatible** | Depends on endpoint | Yes | Hosted or self-hosted | [Configuration Reference §4.15](./configuration-reference.md#415-models-and-defaultmodel). Other local servers (e.g. Open WebUI): [Other OpenAI-compatible provider guide](./other-openai-compatible-provider-implementation-guide.md). |
