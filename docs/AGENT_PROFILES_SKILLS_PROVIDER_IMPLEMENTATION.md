...
- [ ] **P.4.2** User can add/update/delete API keys for a profile via secure UX or RPC; keys never logged or included in prompts.
  ...
  - [ ] **P.4.2.5** UI: Settings/Config section for provider API keys (list providers that use apiKeyRef, masked set/delete per provider).
...
- **Version:** 1.1  
- **Status:** In progress. Agent Profiles (A.1–A.4), Provider/Model (P.1–P.5 except P.4.2.5/P.4.3), Agent Skills (S.1–S.5), and Shared Message View / Tailnet (V.1–V.4) complete. P.4.2.1–P.4.2.4 done (provider credential store, resolveApiKeyAsync, profileRoot, provider.credentials RPCs). Remaining: P.4.2.5 (provider API keys UI), P.4.3 (model list from provider API).  
